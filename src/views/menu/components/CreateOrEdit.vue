  ...
  <div class="menu-create">
    <el-card class="box-card">
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item>
          <el-button type="primary" @click="onSubmit">{{isEdit? '保存' : '添加'}}</el-button>
          <el-button
            v-if="!isEdit"
          >重置</el-button>
        </el-form-item>
...
<script lang="ts">
import Vue from 'vue'
import { createOrUpdateMenu, getEditMenu } from '@/api/menu.ts'
...
export default Vue.extend({
  ...
  methods: {
    async getMenuInfo () {
      const { data } = await getEditMenu(this.$route.params.id || -1)
      if (data.code === '000000') { // 成功
